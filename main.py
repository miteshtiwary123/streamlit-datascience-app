...
""")
st.write("""
### Let's explore different classifier and database
""")

dataset_name = st.sidebar.selectbox('select dataset', ('Brest cancer', 'Iris', 'Wine'))
...
def get_classifier(name_of_clf, params):
    ...
    if name_of_clf == 'SVM':
        ...
        st.warning("You did not select any option")
    return clf
